...
const PLAN_MODE_INSTRUCTION = [
  ...
  "- Once the plan is final, call visual_write once for the required Inline Visual. Follow the same authoring quality bar as VISUAL_AUTHORING (operable model the user manipulates — a flow, algorithm, state machine, or live comparison — not a document poster, architecture board, or equal-card phase deck). The complete plan stays in Markdown + the visual's textual fallback; the visual clarifies that one model, it does not restate the whole plan.",
