...
const PLAN_MODE_INSTRUCTION = [
  ...
  "- Once the plan is final, call visual_write once to author the required primary Inline Visual. It must let the user manipulate information state, not merely navigate static content, and explain the complete plan rather than one isolated detail. visual_write owns its quality, accessibility, language, and performance contract.",
